...
import com.seif.eshraqh.databinding.FragmentQuranBinding
import com.seif.eshraqh.viewmodels.QuranViewModel
import com.seif.eshraqh.ui.fragments.QuranFragmentArgs.fromBundle
...
class QuranFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        quranHashMap["question1"] =
            fromBundle(requireArguments()).quran.quran["question1"].toString()
        quranHashMap["question2"] =
            fromBundle(requireArguments()).quran.quran["question2"].toString()
        quranHashMap["question3"] =
            fromBundle(requireArguments()).quran.quran["question3"].toString()
    ...
    private fun updateCounters() {
        ...
        isRevisionCounterNotFoundUsed =
            fromBundle(requireArguments()).quran.isRevisionCounterNotFoundUsed
        ...
        if (quranHashMap["question3"] == "notFound" && !isRevisionCounterNotFoundUsed) {
            ...
            val revisionCounter: Int =
                7 - fromBundle(requireArguments()).quran.numberOfRevisionDaysToWork
            var currentRevisionCounter =
                AppSharedPref.readRevisionCounter("revisionCounter", revisionCounter)
            ...
            val revisionCounter: Int =
                7 - fromBundle(requireArguments()).quran.numberOfRevisionDaysToWork
            var currentRevisionCounter =
                AppSharedPref.readReadCounter("revisionCounter", revisionCounter)
